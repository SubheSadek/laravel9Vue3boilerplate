		...
		<div class="d-flex flex-column flex-lg-row flex-column-fluid">
			...
			<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" >
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
					...
					<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(assets/media/illustrations/sketchy-1/13.png)">
					...
					<div class="w-lg-500px p-10 p-lg-15 mx-auto" style="margin-top:10% !important;">
						...
						<Form ref="formValidate" :model="formValidate" :rules="ruleValidate" class="form w-100" >
							...
							<div class="text-center">
								...
								<Button :loading="isLoading" :disabled="isLoading" @click="handleSubmit('formValidate')" size="large" type="primary" class="btn btn-lg btn-primary w-100 mb-5">
