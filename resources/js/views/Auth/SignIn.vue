                        ...
                        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" class="form w-100">
                            ...
                            <div class="fv-row mb-10">
                                <FormItem class="form-label fs-6 fw-bolder text-dark" label="Email" prop="email">
                                    <Input v-model="formValidate.email" type="text" placeholder="Email"
                                        autocomplete="off"></Input>
                                </FormItem>
                            </div>

                            <div class="fv-row mb-10">
                                <FormItem class="form-label fw-bolder text-dark fs-6 mb-0" label="Password"
                                    prop="password">
                                    <Input v-model="formValidate.password" type="password" password
